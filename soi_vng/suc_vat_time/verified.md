...
This file includes locked pseudo-labels for train augmentation and rows that still need review. Treat locked labels as pseudo-labeled unless separately verified.

## Counts

- Total IDs: `86`
- Locked/user-added total: `43`
- Needs review total: `43`
- Consensus candidates but not locked: `35`
- Disagreement suspicious: `8`

## Locked / Added Labels

| id | title | final_label | label_s8 | label_s2 | label_s9 | label_abs | review_status | reason |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | Finite Axiomatizability by Disjunctive Existential Rules. | 1 | 1 | 1 | 1 | 5 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
...
| 22 | Past-present temporal programs over finite traces: a preliminary report. | 3 | 3 | 3 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
...
| 35 | On the Suitability of Inconsistency Measures. | 2 | 2 | 2 | 2 | 2 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 51 | Penalization Framework For Autonomous Agents Using Answer Set Programming. | 4 | 4 | 4 | 4 | 2 | locked_user_verified | Top/reference submissions agree, but this is not locked because consensus may still be wrong. user_verified: lock id 51 as label 4. |
| 63 | An Embarrassingly Parallel Model Counter. | 1 | 1 | 1 | 1 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 81 | Reasoning in Defeasible Description Logics with System W and Lexicographic Inference. | 3 | 3 | 3 | 3 | 3 | user_requested_train_addition | user_requested: add/update this id,label pair in augmented train. |
| 101 | Formal Aspects of Strategic Reasoning. | 5 | 5 | 5 | 5 | 3 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 124 | An ASP-Based Framework for MUSes. | 4 | 4 | 4 | 4 | 5 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 126 | Extended Abstract: Early Validation of High-level System Requirements with Event Calculus and Answer Set Programming. | 4 | 4 | 4 | 4 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 129 | Explainability Through Argumentation in Logic Programming. | 3 | 3 | 3 | 3 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 142 | ASP-QRAT: A Conditionally Optimal Dual Proof System for ASP. | 3 | 3 | 3 | 3 | 5 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 144 | Semantic Versioning Checking in a Declarative Package Manager. | 1 | 1 | 1 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 156 | VECSR: Virtually Embodied Common Sense Reasoning System. | 2 | 3 | 3 | 5 | 5 | locked_user_verified | user_requested: add/update this id,label pair in augmented train. moved_to_needs_review: previous output votes are weak or contradictory (2:4, 3:13, 5:2). user_verified: lock id 156 as label 2. |
| 181 | Answer Set Counting and its Applications. | 5 | 5 | 5 | 5 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 210 | Information Extraction Tool Text2ALM: From Narratives to Action Language System Descriptions. | 5 | 5 | 5 | 5 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 211 | VERUS-LM: a Versatile Framework for Combining LLMs with Symbolic Reasoning. | 2 | 3 | 3 | 3 | 3 | locked_user_verified | All checked submissions agree, but this is not locked because public F1 is low. user_verified: lock id 211 as label 2. |
| 219 | Weighted Conditional EL⊥ Knowledge Bases with Integer Weights: an ASP Approach. | 4 | 4 | 4 | 4 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 226 | On the impact of sensors update in declarative AI for videogames. | 1 | 1 | 1 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
...
| 255 | Reasoning in Highly Reactive Environments. | 3 | 4 | 3 | 2 | 2 | locked_user_verified | user_verified: id 255 label 3 confirmed; keep label 3. |
...
| 262 | Efficient OWL2QL Meta-reasoning Using ASP-based Hybrid Knowledge Bases. | 3 | 3 | 3 | 3 | 3 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 281 | On the Complexity of Global Necessary Reasons to Explain Classification. | 5 | 5 | 5 | 5 | 5 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 293 | Extended abstract: 푓퐶퐴푆푃 - A forgetting technique for XAI based on goal-directed constraint ASP models. | 3 | 3 | 3 | 3 | 3 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 295 | Sequence Explanations for Acceptance in Abstract Argumentation. | 3 | 3 | 3 | 3 | 3 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 307 | PEG 2.0: Future-Gazing Through a Socio-Linguistic and Historical Lens. | 3 | 3 | 3 | 3 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 313 | Situation Calculus Temporally Lifted Abstractions for Generalized Planning - Extended Abstract. | 1 | 1 | 1 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 315 | Unifying Abduction and Deduction through Argumentation. | 2 | 2 | 2 | 2 | 3 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 367 | Revising Weighted Knowledge Bases Using FH-Conditioning. | 1 | 1 | 1 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 414 | Solving Recurrence Relations using Machine Learning, with Application to Cost Analysis. | 2 | 2 | 2 | 2 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 428 | A Note on Occur-Check. | 1 | 1 | 1 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 468 | Understanding Restaurant Stories Using an ASP Theory of Intentions. | 5 | 5 | 5 | 5 | 1 | user_requested_train_addition | user_requested: add/update this id,label pair in augmented train. |
| 473 | On Gradual Semantics for Assumption-Based Argumentation. | 3 | 3 | 3 | 3 | 2 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 485 | How well do SOTA legal reasoning models support abductive reasoning? | 5 | 5 | 5 | 5 | 3 | locked_user_verified | Top/reference submissions agree, but this is not locked because consensus may still be wrong. user_verified: lock id 485 as label 5. |
| 498 | Research Summary on Implementing Functional Patterns by Synthesizing Inverse Functions. | 4 | 4 | 4 | 4 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 529 | Sequent-Type Calculi for Systems of Nonmonotonic Paraconsistent Logics. | 1 | 1 | 1 | 1 | 2 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 577 | UserArmor: An extension for AppArmor. | 1 | 1 | 1 | 1 | 1 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 587 | The Impact of Structure in Answer Set Counting: Fighting Cycles and its Limits. | 4 | 4 | 4 | 4 | 4 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
| 591 | Learning to Ground Existentially Quantified Goals. | 5 | 5 | 5 | 5 | 5 | user_added_red_diff_to_train | user_requested_from_red_diff: add this id,label pair to augmented train. |
...
| 88 | Knowledge-Driven Robot Program Synthesis from Human VR Demonstrations. | 1 | 2 | 1 | 2 | 2 | suspicious_locked_review | user_requested: add/update this id,label pair in augmented train. moved_to_needs_review: previous output votes are weak or contradictory (1:10, 2:8, 4:1). |
...
| 114 | Non-Rigid Designators in Modal and Temporal Free Description Logics. | 3 | 1 | 1 | 1 | 1 | suspicious_locked_review | user_requested: add/update this id,label pair in augmented train. moved_to_needs_review: previous output votes are weak or contradictory (1:13, 3:6). |
...
| 217 | Towards Incorporating Normative Requirements In Autonomous Systems Using Datalog. | 2 | 1 | 2 | 1 | 3 | suspicious_locked_review | user_requested: add/update this id,label pair in augmented train. moved_to_needs_review: previous output votes are weak or contradictory (1:10, 2:9). |
...
| 402 | Explaining Actual Causation via Reasoning About Actions and Change. | 4 | 5 | 4 | 5 | 3 | suspicious_locked_review | user_requested: add/update this id,label pair in augmented train. moved_to_needs_review: previous output votes are weak or contradictory (2:3, 4:9, 5:7). |
...
| 509 | A Rule-Based Approach to Specifying Preferences over Conflicting Facts and Querying Inconsistent Knowledge Bases. | 4 | 5 | 4 | 5 | 3 | suspicious_locked_review | user_requested: add/update this id,label pair in augmented train. moved_to_needs_review: previous output votes are weak or contradictory (1:1, 4:9, 5:9). |
